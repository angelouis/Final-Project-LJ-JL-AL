...
public class GameRepositoryTest {
    ...
    public void shouldGetGameByEsrbRating(){
        ...
        assertEquals(game1.get(), game); // makes sures the game can be found by rating
    }
    @Test
    public void shouldGetGameByTitle(){
        ...
        assertEquals(game1.get(), game); // makes sures the game can be found by title
    }
    @Test
    public void shouldGetGameByStudio(){
        ...
        assertEquals(game1.get(), game); // makes sures the game can be found by studio
    }
